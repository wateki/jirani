...
import { Check, Lock, Mail, ShoppingBag, User } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <Link to="/" className="inline-flex items-center">
            <ShoppingBag className="mr-2 h-8 w-8 text-orange-500" />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Get started with your Jirani store in minutes</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <ShoppingBag className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 transform text-gray-400" />
                  <Input
                    id="businessName"
                    type="text"
      ...
      <div className="mt-8 text-center">
        <h3 className="mb-2 text-lg font-semibold">Why choose Jirani?</h3>
